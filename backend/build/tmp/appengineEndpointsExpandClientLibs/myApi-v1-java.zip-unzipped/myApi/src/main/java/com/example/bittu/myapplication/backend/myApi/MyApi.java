 ...
 * on 2016-07-15 at 19:52:03 UTC 
 * Modify at your own risk.
 */

package com.example.bittu.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokes-reader.appspot.com/_ah/api/";
   ...
   * @return the request
   */
  public GetJokes getJokes(java.lang.String type) throws java.io.IOException {
    GetJokes result = new GetJokes(type);
    initialize(result);
    return result;
  }

  public class GetJokes extends MyApiRequest<com.example.bittu.myapplication.backend.myApi.model.JokeCollection> {

    private static final String REST_PATH = "jokecollection/{type}";
     ...
     * @since 1.13
     */
    protected GetJokes(java.lang.String type) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.bittu.myapplication.backend.myApi.model.JokeCollection.class);
    ...
    public GetJokes setType(java.lang.String type) {
      this.type = type;
      return this;
    }
  ...
  /**
   * Create a request for the method "saveJokes".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link SaveJokes#execute()} method to invoke the remote operation.
   *
   * @param type
   * @return the request
   */
  public SaveJokes saveJokes(java.lang.String type) throws java.io.IOException {
    SaveJokes result = new SaveJokes(type);
    initialize(result);
    return result;
  }

  public class SaveJokes extends MyApiRequest<Void> {

    private static final String REST_PATH = "saveJokes/{type}";

    /**
     * Create a request for the method "saveJokes".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link SaveJokes#execute()} method to invoke the remote operation. <p>
     * {@link
     * SaveJokes#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param type
     * @since 1.13
     */
    protected SaveJokes(java.lang.String type) {
      super(MyApi.this, "POST", REST_PATH, null, Void.class);
      this.type = com.google.api.client.util.Preconditions.checkNotNull(type, "Required parameter type must be specified.");
    }

    @Override
    public SaveJokes setAlt(java.lang.String alt) {
      return (SaveJokes) super.setAlt(alt);
    }

    @Override
    public SaveJokes setFields(java.lang.String fields) {
      return (SaveJokes) super.setFields(fields);
    }

    @Override
    public SaveJokes setKey(java.lang.String key) {
      return (SaveJokes) super.setKey(key);
    }

    @Override
    public SaveJokes setOauthToken(java.lang.String oauthToken) {
      return (SaveJokes) super.setOauthToken(oauthToken);
    }

    @Override
    public SaveJokes setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SaveJokes) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SaveJokes setQuotaUser(java.lang.String quotaUser) {
      return (SaveJokes) super.setQuotaUser(quotaUser);
    }

    @Override
    public SaveJokes setUserIp(java.lang.String userIp) {
      return (SaveJokes) super.setUserIp(userIp);
    }
    ...
    public SaveJokes setType(java.lang.String type) {
      this.type = type;
      return this;
    }

    @Override
    public SaveJokes set(String parameterName, Object value) {
      return (SaveJokes) super.set(parameterName, value);
    }
  }
